...
class BnbBreakoutUniform1h(TemplateStrategy):
    """BNB Breakout Uniform — Lookback 32, SL 0.3%, TP 4%.

    6-Coin Uniform profile: identical parameters across all coins.
    Same params as bnb_breakout_relaxed_1h but separate instance
    for the 6-coin-uniform group (avoids name conflict).
