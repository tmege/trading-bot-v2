...
class SolBreakoutSafe1h(TemplateStrategy):
    """SOL Breakout Safe — Lookback 15, SL 1%, TP 6%.

    Backtest: Sharpe +1.65 moyen, positif sur 10/10 fenêtres.
    $1000 → $5,418 (6M compound), $7,592 (1Y compound).
    ...
    def __init__(self):
        super().__init__()
        self.name = "sol_breakout_safe_1h"
        self.tp_pct = 0.06
        self.sl_pct = 0.01
        self.equity_pct = 0.30
        self.leverage = 5
        self.cooldown_sec = 21600.0
